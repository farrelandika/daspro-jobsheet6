...
public class Pemilhan2_percobaan2_equals {
    public static void main(String[] args) {
        ...
        Scanner sembilan = new Scanner(System.in);
         ...
         if (member.equals("y")) { // Menggunakan equalsIgnoreCase untuk membandingkan String
        ...
        } else if (member.equals("n")) { // Mengguakan equalsIgnoreCase untuk membandingkan String
            if (pilihan_menu == 1) {
                harga = 14000;
                System.out.println("Harga Ricebowl = " + harga);
            ...
            }   if (qris.equals("y")) { // Menggunakan equalsIgnoreCase untuk membandingkan String
                potongan = 1000.0;
            ...
            } else if (qris.equals("n")) { // Mengguakan equalsIgnoreCase untuk membandingkan String
                if (pilihan_menu == 1) {
                    harga = 14000;
